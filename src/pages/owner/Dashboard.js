      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <p className="text-sm text-gray-500">
            No store assigned to your account yet. Contact admin.
          </p>
        ) : (
          <>
            <div className="mb-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex justify-between items-center flex-wrap gap-5 shadow-sm">
                ...
                <div className="flex flex-col items-end gap-1">
                  {data.avgRating ? (
                    <>
                      <span className="text-3xl font-bold text-amber-400 leading-none">
                        ★ {data.avgRating}
                      </span>
                      <span className="text-xs text-gray-400">
                        {data.totalRatings} rating
                        {data.totalRatings !== 1 ? "s" : ""}
                      </span>
                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      <th
                        ...
                        className="text-left px-5 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wide cursor-pointer hover:text-blue-500 select-none"
                      >
